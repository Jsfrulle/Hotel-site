...
export const DeleteReservationComponent = ({ item, onClickDelete }) => {
  return (
    <div value={item._id} key={item._id} className="reservarionContainer">
      ...
      <div className="ReservationInfo">
        <p>
          <span className="bold">Individuals:</span> {item.individuals}{" "}
        </p>
        <p>
          {" "}
          <span className="bold">Price: </span>
          {item.priceOfRoom}/person{" "}
        </p>
      </div>
      <p>
        {" "}
      ...
      <p>
        <span className="bold">User:</span> {item.user}{" "}
      </p>
      <p>
        {" "}
        <span className="bold">Reservationnumber: </span>
        {item.reservationId}
      </p>
      <div className="containerBtn">
        <button className="btnUser" onClick={onClickDelete} value={item._id}>
          {" "}
          Delete{" "}
        </button>
      </div>
