...
const store = configureStore({ reducer, preloadedState, preloadedStateTwo, preloadedStateThree, preloadedStateFour});
...
store.subscribe(() => {
  localStorage.setItem('hotelList', JSON.stringify(store.getState().hotelDetails.hotelList))
  localStorage.setItem('roomList', JSON.stringify(store.getState().roomDetail.roomList))
  localStorage.setItem('room', JSON.stringify(store.getState().roomDetail.roomDetails))
  localStorage.setItem('hotelLocation', JSON.stringify(store.getState().hotelLocation.place))
})
